      ...
      <header className="container mx-auto py-6 px-4 flex justify-between items-center relative z-10">
        ...
        <div className="flex items-center gap-2">   
          <Link href="/auth/signup" className="hidden md:block">
            <Button className="bg-gradient-to-r from-purple-600 to-violet-600 hover:from-purple-700 hover:to-violet-700 transition-all duration-300 shadow-lg shadow-purple-900/20">
              Get Started
            </Button>
          </Link>
        </div>
      ...
      <section className="container mx-auto px-4 py-20 md:py-32 relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl text-gray-400 mb-10 max-w-2xl mx-auto leading-relaxed">
            Preppify uses advanced AI to help you prepare for interviews, presentations, and speeches through voice
            interaction.
          </p>
